...
import static dev.forcetower.hilt.android.dynamic.processor.internal.HiltCompilerOptions.isAndroidSuperclassValidationDisabled;
import static dev.forcetower.hilt.android.dynamic.codegen.extension.DaggerStreams.toImmutableSet;
...
public abstract class AndroidEntryPointMetadata {
    ...
    private static final ImmutableSet<ClassName> DYNAMIC_HILT_ANNOTATION_NAMES =
            ImmutableSet.of(
    ...
    private static ImmutableSet<? extends AnnotationMirror> hiltAnnotations(Element element) {
        return element.getAnnotationMirrors().stream()
                .filter(mirror -> DYNAMIC_HILT_ANNOTATION_NAMES.contains(ClassName.get(mirror.getAnnotationType())))
